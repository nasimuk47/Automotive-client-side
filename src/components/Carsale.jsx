...
const Carsale = () => {
    return (
        <div>
            <div className="bg-sky-400 w-[500]  text-center mt-5 ">
                <div>
                    ...
                    <h2 className="text-xl font-serif text-gray-700">
                        Here are some recent car checks we~ve carried out
                    </h2>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-4   mt-10 ml-10">
                    {/* 1st card */}
